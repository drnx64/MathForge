...
export function Toolbar({ onInsert, onInsertSnippet, onRandomVar, theme, onToggleTheme, onToggleGrid, showGrid, onToggleSidebar, sidebarOpen, onOpenMatrix }: ToolbarProps) {
  return (
